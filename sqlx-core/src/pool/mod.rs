...
///
/// Connection pools enforce reuse of connections to _amortize_ these costs, helping to ensure
...
///
/// As with section 1, by enforcing reuse of connections, `Pool` helps to ensure their prepared
